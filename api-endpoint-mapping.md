...
| 인증·온보딩              | 토큰 재발급               | seonghun   | POST   | /api/v1/auth/refresh                                          | RefreshTokenRequest              | RefreshTokenResponse                |
| 인증·온보딩              | 로그아웃                  | seonghun   | POST   | /api/v1/auth/logout                                           | -                                | 204 No Content                      |
| 인증·온보딩              | 약관 동의 기록            | seonghun   | POST   | /api/v1/agreements                                            | UserAgreementRequest             | UserAgreementResponse               |
| 인증·온보딩              | 닉네임 중복확인           | seonghun   | GET    | /api/v1/users/nickname/availability?nickname=                 | nickname(query)                  | NicknameAvailabilityResponse        |
