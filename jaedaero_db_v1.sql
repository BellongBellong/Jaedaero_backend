...
CREATE TABLE cashflow_forecast (
                                   ...
                                   expected_asset           BIGINT NOT NULL DEFAULT 0 COMMENT '미확정 혜택을 제외한 보수적 전역 예상 자산',
                                   ...
                                   potential_expected_asset BIGINT NOT NULL DEFAULT 0 COMMENT '보수적 예상 자산과 예상 혜택 합계',
                                   calculation_policy_version VARCHAR(50) NOT NULL DEFAULT 'LEGACY_BEFORE_CONSERVATIVE_V2' COMMENT '캐시플로우 계산 정책 버전',
