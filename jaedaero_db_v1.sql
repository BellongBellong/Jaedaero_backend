...
(
    ...
    CONSTRAINT chk_rebalancing_ratio_sum CHECK (
        recommended_safe_ratio + recommended_balanced_ratio +
        recommended_aggressive_ratio BETWEEN 99.00 AND 101.00
        )
...
INSERT INTO badge (badge_name,
                   ...
                   image_url,
                   is_active)
VALUES ('안정형 브론즈', '안정형 미션 1개 완료', 'MISSION_COUNT', 'SAFE', 1, 'BRONZE', NULL, TRUE),
