...
public class SensitiveValueCipher {
    ...
    public SensitiveValueCipher(@Value("${app.crypto.master-key-base64}") String base64Key) {
        ...
        try {
            ...
            throw new IllegalStateException("app.crypto.master-key-base64 must be Base64 encoded.", exception);
        }
        if (keyBytes.length != 32) {
            throw new IllegalStateException("app.crypto.master-key-base64 must decode to a 32-byte AES-256 key.");
        }
