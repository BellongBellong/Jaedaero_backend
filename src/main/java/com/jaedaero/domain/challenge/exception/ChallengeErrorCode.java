...
public enum ChallengeErrorCode implements ErrorCode {
  ...
  CHALLENGE_GROUP_NOT_FOUND(HttpStatus.NOT_FOUND, "CHALLENGE_GROUP_NOT_FOUND"),
  INVALID_RANKING_MONTH(HttpStatus.BAD_REQUEST, "INVALID_RANKING_MONTH"),
  ...
  MISSION_COMPLETION_RETRY_EXHAUSTED(
      HttpStatus.SERVICE_UNAVAILABLE, "MISSION_COMPLETION_RETRY_EXHAUSTED");
