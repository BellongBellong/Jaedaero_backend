...
public class CodefDemoUnifiedAssets {
    ...
    public CodefDemoUnifiedAssets(
            String totalAmount, int refreshedAccountCount, List<CodefDemoInstitutionAssetGroup> institutionGroups) {
    ...
    public int getRefreshedAccountCount() { return refreshedAccountCount; }
    public List<CodefDemoInstitutionAssetGroup> getInstitutionGroups() { return institutionGroups; }
}
