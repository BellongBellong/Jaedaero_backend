...
public class CodefDemoInstitutionAssetGroup {
  ...
  public CodefDemoInstitutionAssetGroup(
      String institutionName, List<CodefDemoUnifiedAccountAsset> accounts) {
  ...
  public List<CodefDemoUnifiedAccountAsset> getAccounts() {
    return accounts;
  }
}
