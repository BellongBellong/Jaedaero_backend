...
public record EtfReturnPeriod(
    ...
    @ApiModelProperty(value = "실제 적용된 거래일. 해당 기간에 상장 전이면 null", example = "20260128")
        String baseDate,
    @ApiModelProperty(value = "기준일 종가. 해당 기간에 상장 전이면 null", example = "50000")
        String baseClosePrice,
    @ApiModelProperty(value = "수익률(%). 해당 기간에 상장 전이면 null", example = "12.34")
