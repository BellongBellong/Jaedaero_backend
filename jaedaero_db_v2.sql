-- ============================================================
-- JAEDAERO Database Baseline v2.0 (2026-08-13)
-- Target: MySQL 8.4 / utf8mb4
--
-- 주의: 신규 환경 구축 또는 전체 초기화 전용 스크립트입니다.
...
-- ---------------------------------------------
-- 13. account_transaction_sync : 계좌별 거래내역 동기화 범위
-- ---------------------------------------------
...
-- ---------------------------------------------
-- 15. challenge_group : 입대 동기 챌린지 그룹
-- ---------------------------------------------
...
-- ---------------------------------------------
-- 17. challenge_monthly_result : 월별 챌린지 결과
-- ---------------------------------------------
...
-- ---------------------------------------------
-- 18. challenge_member_summary : 챌린지 참여자 누적 현황
-- ---------------------------------------------
...
-- ---------------------------------------------
-- 19. simulation : 사용자 What-if 시뮬레이션
-- ---------------------------------------------
...
-- ---------------------------------------------
-- 22. military_benefit : 군인 혜택 및 청년 정책
-- ---------------------------------------------
...
-- ---------------------------------------------
-- 23. product_recommendation : 금융 상품 추천
-- ---------------------------------------------
...
-- ---------------------------------------------
-- 24. ai_recommended_scenario : AI 추천 시나리오
-- ---------------------------------------------
...
-- ---------------------------------------------
-- 25. recurring_investment_plan : 사용자 적립식 위험자산 투자 계획
-- ---------------------------------------------
...
-- ---------------------------------------------
-- 26. investment_guidance : 목표 기반 다음 적립금 가이드
-- ---------------------------------------------
...
-- ---------------------------------------------
-- 27. strategy_application : 전략 적용 이력
-- ---------------------------------------------
...
-- ---------------------------------------------
-- 29. refresh_token : JWT Refresh Token 관리
-- ---------------------------------------------
...
-- ---------------------------------------------
-- 31. user_mission_completion : 사용자별 미션 완료 이력
-- ---------------------------------------------
...
-- ---------------------------------------------
-- 34. investment_badge : 사용자별 투자 뱃지 집계
-- ---------------------------------------------
...
-- ---------------------------------------------
-- 35. leave_mode : 사용자 일정 및 휴가모드 전환
-- ---------------------------------------------
...
-- ---------------------------------------------
-- 36. daily_market_report : 오늘의 AI 시장 리포트
-- ---------------------------------------------
...
-- ---------------------------------------------
-- 37. daily_market_indicator : 오늘의 AI 시장 리포트 지표 원본값
-- ---------------------------------------------
...
-- ---------------------------------------------
-- 38. daily_market_report_source : 오늘의 AI 시장 리포트 인용 출처
-- ---------------------------------------------
...
-- ---------------------------------------------
-- 40. notification_history : 알림 발송 이력
-- ---------------------------------------------
